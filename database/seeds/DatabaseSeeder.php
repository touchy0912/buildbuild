...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('roles')->insert([
            ...
            'rule2' => 'メンバー全員が1人2回以上発言できるよう議論を取り仕切る。',
            ],
            ['role' => '副キャプテン',
            'rule1' => 'あなたは潤滑油です！議論を仕切っている人を全力でサポートしましょう！',
            'rule2' => 'ほかの人と比べて意見を言えていない2人を見つけ出し、話を振りましょう。',
            ],
            ['role' => 'フカホリさん',
            ...
            'rule2' => '大きな相槌3回以上、意見への賛同やポジティブなコメント3回以上　実行する',
            ],
            ['role' => 'タイムマネージャー',
            ...
            'rule2' => '簡潔にメモに取り、全員に1回以上リマインドする。（ホワイトボード使用可）',
            ],
